...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, relu_type = 'prelu', dropout=0.0):
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_tokens=1000, relu_type='relu', gamma_zero=False, 
                 avg_pool_downsample=False, dropout_rate=0.0):
        self.inplanes = 64
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers.append(block(self.inplanes, planes, stride, downsample, 
                           relu_type=self.relu_type, dropout=self.dropout))
